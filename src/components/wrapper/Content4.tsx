        ...
        {getVisibleItems(items, 6).map((i, index) => (
          <div className="w-full flex gap-4">
            <div className="flex-1 flex flex-col gap-4">
              <div
                className=" h-[429.98px] bg-cover bg-no-repeat bg-center rounded-[8px] relative"
                style={{
              ...
              <div className="flex-1 pl-[66px] flex relative">
                <div
                  className="absolute top-0 left-0 w-[50px] text-[58.8px] leading-[100%] font-extrabold italic z-3 text-center"
                  style={{
                    background:
                ...
                <div className="h-full w-full">
                  <h4 className="text-white text-sm font-medium leading-[18.9px]">
                    {i.name}
                  </h4>
                  <h4 className="text-white/40 text-xs leading-[18.9px]">
                    {i.type}
                  </h4>
                  <div className="flex leading-[18.9px]">
