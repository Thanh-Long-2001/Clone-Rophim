    ...
    <div className="w-full 2xl:px-12.5 md:px-5 px-4">
      <div className="w-full">
        <div className="text-white mb-[19.2px] flex items-center gap-4">
          <h3 className="2xl:text-[28px] font-semibold leading-1.4 max-2xl:text-[22.4px] w-fit max-md:flex-1">
        ...
        <div className="xl:h-125 lg:h-115 h-100 relative rounded-[19.2px] bg-[#2F3346] cursor-pointer">
          <div className="backgroundI lg:h-full h-62.5 absolute right-0 mask-img mask-img2">
            <div
              className="w-full h-full bg-cover bg-center bg-no-repeat rounded-[19.2px]"
              style={{ backgroundImage: `url(${BgAnime})` }}
            ></div>
          </div>
          <div className="max-lg:pt-25 h-full flex">
            <div className="xl:max-w-[700px] lg:max-w-150 max-w-full 2xl:p-12 lg:p-8 z-2 max-lg:p-5 relative h-fit">
              ...
              <div className=" text-white text-[14px] lg:mb-6 text-ellipsis line-clamp-3 overflow-hidden whitespace-normal">
                Trong một thế giới loạn lạc bởi chiến tranh giữa loài người và
                các bộ tộc á nhân, Kai – một cậu bé bình thường ở làng Rag –
                ngày ngày chiến đấu để bảo vệ quê hương. Giữa những trận chiến
                khốc liệt, cậu bất ngờ nhớ lại ký ức về một thế giới hiện đại mà
                mình chưa từng sống. Từ đó, Kai bị cuốn vào những biến cố lớn,
                bắt đầu hành trình trưởng thành giữa một thế giới đầy thử thách
                và hiểm nguy.
              </div>
              <div className="flex gap-8 items-center max-lg:hidden">
                ...
                <div className="flex border-[2px] rounded-[30px] text-white  border-white/10 hover:border-white group">
                  <div className="pl-[6.4px] pr-[3.2px] flex justify-center items-center min-w-17  h-[50px] border-r-1 border-white/10 group-hover:border-white hover:text-[#FFD875]">
                    <svg
                  ...
                  <div className="pr-[6.4px] pl-[3.2px] flex justify-center items-center min-w-17  h-[50px] border-l-1 border-white/10 group-hover:border-white hover:text-[#FFD875]">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
                      height="21"
        ...
        <div className="relative lg:-mt-[70px] w-fit mx-auto lg:mx-4 max-lg:my-4 xl:mx-auto">
          <div className="xl:w-300 w-full flex flex-wrap xl:gap-4 gap-2">
            {listImgAnime.map((i, index) => (
              <div className="xl:h-[88.594px] flex-1  max-xl:aspect-square cursor-pointer">
                <img
                  className={`max-lg:hidden w-full h-full max-xl:rounded-full rounded-lg border-[3px] max-lg:w-2.5 max-lg:h-2.5 ${
                    index === 0 ? "border-white" : "border-[#2f3346]"
                  }`}
                  src={i}
                />
                <div
                  className={`lg:hidden w-2.5 h-2.5 rounded-full max-lg:block hidden ${
                    index === 0 ? "bg-[#FFD875]" : "bg-white"
                  }`}
                />
              </div>
            ))}
